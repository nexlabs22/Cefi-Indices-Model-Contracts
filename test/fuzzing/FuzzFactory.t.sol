...
contract CounterTest is Test {
    ...
    function testFuzz_Initialized(uint amount) public {
    ...
    function testFuzz_SetUsdcAddress(uint amount) public {
    ...
    function testFuzz_SetTokenAddress(uint amount) public {
        assertEq(address(factory.token()), address(indexToken));
        //expect revert for address zero
        vm.expectRevert("invalid token address");
    ...
    function testFuzz_SetIssuer(uint amount) public {
    ...
    function testFuzz_SetCustodianWallet(uint amount) public {
    ...
    function testFuzz_MintTokens(uint amount) public {
    ...
    function testFuzz_ErroConfirmNotPendingRequest(uint amount) public {
        IndexFactory.Request[] memory mintRequests = factory.getAllMintRequests();
        assertEq(mintRequests.length, 0);
        usdc.transfer(add1, 1000e6 + 1000e6*10/10000);
        vm.startPrank(add1);
    ...
    function testFuzz_MintRequestWhenPaused(uint amount) public {
        factory.pause();
        IndexFactory.Request[] memory mintRequests = factory.getAllMintRequests();
        assertEq(mintRequests.length, 0);
        usdc.transfer(add1, 1000e6 + 1000e6*10/10000);
    ...
    function testFuzz_BurnTokens(uint amount) public {
        IndexFactory.Request[] memory mintRequests = factory.getAllMintRequests();
    ...
    function testFuzz_BurnErrorForNonPendingRequest(uint amount) public {
        IndexFactory.Request[] memory mintRequests = factory.getAllMintRequests();
        IndexFactory.Request[] memory burnRequests = factory.getAllBurnRequests();
        assertEq(mintRequests.length, 0);
        usdc.transfer(add1, 1000e6 + 1000e6*10/10000);
