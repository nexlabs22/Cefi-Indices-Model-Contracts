...
contract MockApiOracle is ChainlinkRequestInterface, LinkTokenReceiver {
  ...
  function fulfillOracleFundingRateRequest(bytes32 _requestId, address[] memory _addresses, uint256[] memory _marketCapShares)
    external
    ...
    returns (bool)
  {
    ...
    (bool success, ) = req.callbackAddr.call(
      ...
      abi.encodeWithSelector(req.callbackFunctionId, _requestId, _addresses, _marketCapShares)
